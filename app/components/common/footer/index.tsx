...
export const Footer = () => {
  return (
    <footer className="relative pt-10 pb-45 px-5 w-full bg-black overflow-hidden">
      <svg
        className="absolute -bottom-30 left-0 w-full h-full pointer-events-none"
        width="1000"
        height="400"
        viewBox="0 0 68 26"
        fill="none"
      ...
      <div className="flex flex-col gap-8">
        <div className="flex justify-center">
          <ul className="flex items-center gap-4">
            <li className="text-sm text-neutral-400 cursor-pointer">
              Sobre
            </li>
            <li className="text-sm text-neutral-400 cursor-pointer">
              Serviços
